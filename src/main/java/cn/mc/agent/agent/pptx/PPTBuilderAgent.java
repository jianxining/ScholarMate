package cn.mc.agent.agent.pptx;

import cn.mc.agent.agent.BaseAgent;
import cn.mc.agent.agent.pptx.strategy.PptStateStrategyContext;
import cn.mc.agent.agent.pptx.strategy.PptStateStrategyFactory;
import cn.mc.agent.common.AppContextClient;
...
import cn.mc.agent.entity.record.pptx.PptIntentResult;
...
public class PPTBuilderAgent extends BaseAgent {
    ...
    public PPTBuilderAgent(ChatModel chatModel, List<ToolCallback> toolCallbacks, AiSessionService sessionService, AgentTaskManager taskManager) {
        super(chatModel, "PPTBuilderAgent","pptx");
